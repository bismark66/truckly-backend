...
export class AddUserProfileFields1770907210586 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "driver" ADD "isOnline" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "driver" ADD "rating" numeric(3,2) NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "driver" ADD "totalTrips" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "driver" ADD "totalEarnings" numeric(10,2) NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "fleet" ADD "dotNumber" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "fleet" ADD "mcNumber" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "fleet" ADD "fleetSize" character varying`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "fleet" ADD "monthlyLoads" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "fleet" ADD "isVerified" boolean NOT NULL DEFAULT false`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "fleet" DROP COLUMN "operatingRegions"`,
    );
